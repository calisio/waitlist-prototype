...
const mockPrograms = [
  {
    id: 1,
    name: "GED Program",
    description: "Prepare for and earn your General Educational Development certificate",
    capacity: 30,
    enrolled: 15,
    waitlistCount: 4,
    pendingKites: 3
  ...
  },
  {
    ...
    description: "Build job search skills, resume writing, and interview techniques",
    capacity: 40,
    enrolled: 35,
    waitlistCount: 12,
    pendingKites: 5
  ...
  },
  {
    ...
    description: "Professional communication and writing skills for the workplace",
    capacity: 35,
    enrolled: 28,
    waitlistCount: 5,
    pendingKites: 0
...
function AdminProgramList() {
  ...
  const totalWaitlisted = programs.reduce((sum, p) => sum + p.waitlistCount, 0);
  const totalPendingKites = programs.reduce((sum, p) => sum + p.pendingKites, 0);
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage enrollments, waitlists, and kite requests</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-1">{totalEnrolled}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 font-medium">On Waitlists</p>
                <p className="text-3xl font-bold text-gray-900 mt-1">{totalWaitlisted}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600 font-medium">Pending Kites</p>
                <p className="text-3xl font-bold text-gray-900 mt-1">{totalPendingKites}</p>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            ...
            <p className="text-sm text-gray-600 mt-1">{programs.length} active programs</p>
          </div>
                      ...
                      <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600">
                            Enrolled: <span className="font-medium text-gray-900">{program.enrolled}/{program.capacity}</span>
                          </span>
                          {!isFull && (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-600">
                            Waitlist: <span className="font-medium text-gray-900">{program.waitlistCount}</span>
                          </span>
                        </div>
                      </div>
                    </div>
