        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Browse and request to join educational programs</p>
            </div>
      ...
      {showConfirmation && (
        <div className="fixed top-4 right-4 bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg z-50 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-green-100">An administrator will review your request</p>
          </div>
        </div>
      )}
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    <span>
                      Capacity: <span className="font-medium text-gray-700">{program.enrolled}/{program.capacity}</span>
                    </span>
                    <span className="text-gray-300">•</span>
                    <span>
                      {program.capacity - program.enrolled > 0 
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-500 mt-1">
                This note will help administrators review your request
              </p>
            </div>
